...
def perform(fecha1,fecha2,user_id)
    ...
    Sellvale.where("fecha>=? and fecha <=?", "2021-11-26 00:00:00","2021-12-12 23:59:59").update_all("cantidad =  CAST(importe as  float ) / CAST( precio AS float) ")
             ...
             saldo_acum = 0 
              ...
              if @varillas       
                ...
                for  varillas  in @varillas            
                     ...
                     saldo_inicial = varillas.get_saldo_inicial(fecha_dia_anterior,fecha_dia_anterior,tanques0.product.id).last.varilla  
