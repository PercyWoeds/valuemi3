class SellvalesController < ApplicationController
  ...
  def index
    ...
    if current_user.email == "percywoeds@gmail.com"  || @current_user.level == "parte"  
      ...
      @sellvales2 = Sellvale.select("id,fecha,serie,numero,cod_prod,cantidad,precio,importe").where("fecha>=? and fecha<=?","2019-03-01 00:00:00","2019-03-31 23:59:59").order(:fecha,:serie,:numero)
