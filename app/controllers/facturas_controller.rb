...
##-------------------------------------------------------------------------------------
  ...
  def build_pdf_body_rpt15(pdf)
    ...
    pdf.font "Helvetica" , :size => 6
     ...
     for  customerpayment_rpt in @factras_rpt
  ...
  @total_cliente =@total_dia01+
        ...
        row = []
         ...
         row << sprintf("%.2f",@total_dia01_column.to_s)
         row << sprintf("%.2f",@total_dia02_column.to_s)
         row << sprintf("%.2f",@total_dia03_column.to_s)
         row << sprintf("%.2f",@total_dia04_column.to_s)
         row << sprintf("%.2f",@total_dia05_column.to_s)
         row << sprintf("%.2f",@total_dia06_column.to_s)
         row << sprintf("%.2f",@total_dia07_column.to_s)
         row << sprintf("%.2f",@total_dia08_column.to_s)
         row << sprintf("%.2f",@total_dia09_column.to_s)
         row << sprintf("%.2f",@total_dia10_column.to_s)
         row << sprintf("%.2f",@total_dia11_column.to_s)
         row << sprintf("%.2f",@total_dia12_column.to_s)
         row << sprintf("%.2f",@total_dia13_column.to_s)
         row << sprintf("%.2f",@total_dia14_column.to_s)
         row << sprintf("%.2f",@total_dia15_column.to_s)
         row << sprintf("%.2f",@total_dia16_column.to_s)
         row << sprintf("%.2f",@total_dia17_column.to_s)
         row << sprintf("%.2f",@total_dia18_column.to_s)
         row << sprintf("%.2f",@total_dia19_column.to_s)
         row << sprintf("%.2f",@total_dia20_column.to_s)
         row << sprintf("%.2f",@total_dia21_column.to_s)
         row << sprintf("%.2f",@total_dia22_column.to_s)
         row << sprintf("%.2f",@total_dia23_column.to_s)
         row << sprintf("%.2f",@total_dia24_column.to_s)
         row << sprintf("%.2f",@total_dia25_column.to_s)
         row << sprintf("%.2f",@total_dia26_column.to_s)
         row << sprintf("%.2f",@total_dia27_column.to_s)
         row << sprintf("%.2f",@total_dia28_column.to_s)
         row << sprintf("%.2f",@total_dia29_column.to_s)
         row << sprintf("%.2f",@total_dia30_column.to_s)
         row << sprintf("%.2f",@total_dia31_column.to_s)
