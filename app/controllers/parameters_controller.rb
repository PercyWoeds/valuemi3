class ParametersController < ApplicationController
  ...
  def show
    @parameter_details = @parameter.parameter_details
  end
  ...
  private
    ...
    def parameter_params
      params.require(:parameter).permit(:code, :fecha, :onp, :sctr_1, :sctr_2, :essalud,:asigfamiliar)
    end
end
