...
def get_tax3(items, supplier_id)
    ...
    for item in items
      if(item and item != "")
        ...
        begin
          ...
          :total => total.to_f,:grifo=> grifo.to_f,:mayorista=> mayorista.to_f)
  ...
  def get_products    
    ...
    if self.tipo == "1"
      ...
      servicebuys.name,purchase_details.id,purchase_details.fecha1,purchase_details.fecha2,purchase_details.fecha3,purchase_details.qty1,purchase_details.qty2,purchase_details.qty3  from purchase_details INNER JOIN servicebuys ON 
    ...
    @itemproducts = PurchaseDetail.find_by_sql(['Select purchase_details.price_with_tax as price,purchase_details.quantity,
      purchase_details.discount,purchase_details.price_without_tax as price2,purchase_details.total,
      products.name,purchase_details.id ,purchase_details.fecha1,purchase_details.fecha2,purchase_details.fecha3,purchase_details.qty1,purchase_details.qty2,purchase_details.qty3 
       from purchase_details INNER JOIN products ON 
