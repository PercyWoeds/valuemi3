...
class CategoriaControllerTest < ActionController::TestCase
  ...
  test "should create categorium" do
    assert_difference('Categorium.count') do
      post :create, categorium: { code: @categorium.code, company_id: @categorium.company_id, descrip: @categorium.descrip }
    end
  ...
  test "should update categorium" do
    patch :update, id: @categorium, categorium: { code: @categorium.code, company_id: @categorium.company_id, descrip: @categorium.descrip }
    assert_redirected_to categorium_path(assigns(:categorium))
  end
